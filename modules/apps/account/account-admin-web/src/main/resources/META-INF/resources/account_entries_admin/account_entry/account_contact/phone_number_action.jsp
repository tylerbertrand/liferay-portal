...
ContactInformationActionDropdownItemsProvider contactInformationActionDropdownItemsProvider = new ContactInformationActionDropdownItemsProvider(request, ListTypeConstants.PHONE, "/account_entries_admin/account_entry/account_contact/edit_phone_number.jsp", phone.getPhoneId(), renderResponse, phone.getClassName(), phone.getClassPK());
%>
