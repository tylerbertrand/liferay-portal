...
function main() {
	...
	const mappableVideoUrl = mappableVideoUrlNode
		? mappableVideoUrlNode.textContent.trim()
		: null;
	...
	try {
		...
		if (
			configuration.useMappableUrl &&
			!mappableVideoUrl.includes('Click here to map your video.')
		) {
